          ...
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-6 col-sm-6">
                <h1 class="m-0 text-primary text-bold">User Task</h1>
              </div><!-- /.col -->
              <div class="col-6 col-sm-6">
                    ...
                    <div class="col-3 px-1">
                      ...
                      <div class="row">
                        ...
                        <div class="col-4 pl-1">
                          <router-link to="/add-user-task" class="btn btn-sm btn-block bg-gradient-success" type="button"  ><i class="fa fa-plus-circle"></i> Add</router-link>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    methods:{
      ...
      resetForm(){
        ...
        getAllTask(){
            ...
            this.isLoading = true;
            Api().get('/only-user-task/?phone='+this.phone+'&&page='+this.pagination.current_page)
            .then(response =>{
